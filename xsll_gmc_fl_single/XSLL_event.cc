...
namespace Belle{
  ...
  void XSLL::event_start()
  {
    ...
    if( fl_message_xs ) std::cout << "XSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXS" << std::endl
				  << " # of Xs candidates : " << xs_list.size()                                       << std::endl
				  << "XSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXSXS" << std::endl;
    Rec_B ( recb_list, pseudo_cc_list, xs_list );
    if( fl_message_b_ana ) std::cout << "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB" << std::endl
				     << " # of B candidates : " << recb_list.size()                                      << std::endl
				     << "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB" << std::endl;

...
set OUT = "script_lambdaone429/${FLAG}_${FILE}_m${MODE}m_${LEVEL}${TAG}.sh"      
...
set FACTOR = `grep $NAME_MODE ~/script/scale_sigmc_factor_for_correction_function.txt | cut -f 2`

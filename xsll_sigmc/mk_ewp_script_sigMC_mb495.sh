...
#set OUT = 'script_mb495/'$FLAG'_'$FILE'_m'$MODE'm_'$LEVEL$TAG'.sh'      
set OUT = 'script_mb495_c10flip/'$FLAG'_'$FILE'_m'$MODE'm_'$LEVEL$TAG'.sh'      
...
set FACTOR = `grep $NAME_MODE ~/script/scale_sigmc_factor_mb495.txt | cut -f 2`

...
set OUT = 'script_fm200/'$FLAG'_'$FILE'_m'$MODE'm_'$LEVEL$TAG'.sh'      
#set OUT = 'script_fm200_c10flip/'$FLAG'_'$FILE'_m'$MODE'm_'$LEVEL$TAG'.sh'      
...
set FACTOR = `grep $NAME_MODE ~/script/scale_sigmc_factor_fm200.txt | cut -f 2`

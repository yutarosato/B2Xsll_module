...
set OUT = 'script_fm480/'$FLAG'_'$FILE'_m'$MODE'm_'$LEVEL$TAG'.sh'      
#set OUT = 'script_fm480_c10flip/'$FLAG'_'$FILE'_m'$MODE'm_'$LEVEL$TAG'.sh'      
...
set FACTOR = `grep $NAME_MODE ~/script/scale_sigmc_factor_fm480.txt | cut -f 2`

...
namespace Belle{
  ...
  HepSymMatrix XSLL::calib_trk_err( Particle par, double scale ){
    HepSymMatrix m_error(7,0);
    Mdst_charged     p        = par.mdstCharged();
    Ptype           &ptype    = par.pType();
    HepPoint3D       newPivot = HepPoint3D(0.,0.,0.);
    HepLorentzVector m_momentum();
    HepPoint3D       m_position = HepPoint3D();
    ...
    Ea[0][0] = scale*p.trk().mhyp(hyp).error(0);
    Ea[1][0] = scale*p.trk().mhyp(hyp).error(1);
    Ea[1][1] = scale*p.trk().mhyp(hyp).error(2);
    Ea[2][0] = scale*p.trk().mhyp(hyp).error(3);
    Ea[2][1] = scale*p.trk().mhyp(hyp).error(4);
    Ea[2][2] = scale*p.trk().mhyp(hyp).error(5);
    Ea[3][0] = scale*p.trk().mhyp(hyp).error(6);
    Ea[3][1] = scale*p.trk().mhyp(hyp).error(7);
    Ea[3][2] = scale*p.trk().mhyp(hyp).error(8);
    Ea[3][3] = scale*p.trk().mhyp(hyp).error(9);
    Ea[4][0] = scale*p.trk().mhyp(hyp).error(10);
    Ea[4][1] = scale*p.trk().mhyp(hyp).error(11);
    Ea[4][2] = scale*p.trk().mhyp(hyp).error(12);
    Ea[4][3] = scale*p.trk().mhyp(hyp).error(13);
    Ea[4][4] = scale*p.trk().mhyp(hyp).error(14);
    //*/
    /* scale for only drho and dz 
    Ea[0][0] =      scale *p.trk().mhyp(hyp).error(0);
    Ea[1][0] = sqrt(scale)*p.trk().mhyp(hyp).error(1);
    Ea[1][1] =             p.trk().mhyp(hyp).error(2);
    Ea[2][0] = sqrt(scale)*p.trk().mhyp(hyp).error(3);
    Ea[2][1] =             p.trk().mhyp(hyp).error(4);
    Ea[2][2] =             p.trk().mhyp(hyp).error(5);
    Ea[3][0] =      scale *p.trk().mhyp(hyp).error(6);
    Ea[3][1] = sqrt(scale)*p.trk().mhyp(hyp).error(7);
    Ea[3][2] = sqrt(scale)*p.trk().mhyp(hyp).error(8);
    Ea[3][3] =      scale *p.trk().mhyp(hyp).error(9);
    Ea[4][0] = sqrt(scale)*p.trk().mhyp(hyp).error(10);
    Ea[4][1] =             p.trk().mhyp(hyp).error(11);
    Ea[4][2] =             p.trk().mhyp(hyp).error(12);
    Ea[4][3] = sqrt(scale)*p.trk().mhyp(hyp).error(13);
  ...
  HepSymMatrix XSLL::calib_trk_err2( Particle par, double scale ){
    HepSymMatrix m_error(7,0);
    Mdst_charged     p        = par.mdstCharged();
    Ptype           &ptype    = par.pType();
    HepPoint3D       newPivot = HepPoint3D(0.,0.,0.);

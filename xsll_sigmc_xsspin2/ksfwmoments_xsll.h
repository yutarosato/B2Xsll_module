...
// ksfwmoments_xsll
// ----------------------------------------------------------------------
class ksfwmoments_xsll {
public:
  ksfwmoments_xsll() : m_uf(0) {};
  ksfwmoments_xsll(const Particle &cand, double ebeam, const Hep3Vector &cmboost, const bool fl_final_xs, const bool fl_message=false);
  ~ksfwmoments_xsll() {};
